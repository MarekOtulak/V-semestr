...
@WebServlet("/BeginCtrl")
public class BeginCtrl extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        System.out.println("BeginCtrl działa poprawnie");
        resp.getWriter().write("BeginCtrl działa poprawnie");
    }
}
